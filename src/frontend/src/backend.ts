...
import type { Gender as _Gender, OPDRecord as _OPDRecord, PatientProfile as _PatientProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllOPDRecords(): Promise<Array<OPDRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllOPDRecords();
    ...
    async getAllPatientProfiles(): Promise<Array<PatientProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPatientProfiles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPatientOPDRecords(arg0: Principal): Promise<Array<OPDRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPatientOPDRecords(arg0);
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPatientProfile(arg0: Principal): Promise<PatientProfile | null> {
        if (this.processError) {
            try {
    ...
    async registerPatient(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitOPDForm(arg0: string, arg1: bigint, arg2: string, arg3: Gender, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitOPDForm(arg0, arg1, arg2, to_candid_Gender_n11(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_OPDRecord_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OPDRecord): OPDRecord {
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OPDRecord>): Array<OPDRecord> {
    return value.map((x)=>from_candid_OPDRecord_n4(_uploadFile, _downloadFile, x));
}
